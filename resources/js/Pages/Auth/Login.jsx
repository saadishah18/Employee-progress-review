  ...
  return (
    <AuthLayout>
      ...
      <div className="at-loginpage w-full h-full">
        <div className="at-logincontent block lg:flex justify-between">
          <figure className="at-loginimage top-0 left-0 -z-0 absolute lg:relative w-full lg:w-1/2 overflow-hidden h-[100vh] bg-themebgcolor flex justify-center">
            <img
              className=""
          ...
          <div className="at-authformholder md:flex items-center justify-center flex-col lg:block bg-white bg-opacity-80 lg:bg-opacity-100 relative w-full lg:w-1/2 h-screen overflow-auto p-[30px] lg:pt-12 lg:pl-16 lg:pr-16 lg:pb-4 xl:pt-20 xl:pl-32 xl:pr-52 xl:pb-8">
            <div className="at-authhead w-full mb-[30px] lg:mb-[46px] xl:mb-[66px]">
              <strong className="at-logo w-full mb-5 lg:mb-20 xl:mb-44 block">
                <img
                  className="w-[15.625rem] block h-auto"
            ...
            <form className="w-full" onSubmit={submit} autoComplete="off">
              ...
              <div className="flex items-center justify-end mt-7">
                {canResetPassword && (
                  <Link
                    ...
                    className=" text-sm text-[#9d9d9d] font-product-sansregular hover:text-black"
                  >
                    Forgot Password?
                  </Link>
                )}
              ...
              <div className="flex items-center justify-center w-full mt-14">
                ...
                <PrimaryButton
                  ...
                  processing={
                    !(data.email && data.password) ? true : processing
                  }
                >
                  Login
                  {/* Spinner Start */}
