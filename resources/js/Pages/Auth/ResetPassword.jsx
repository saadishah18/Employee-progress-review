        ...
        <AuthLayout>
            ...
            <div className="at-loginpage w-full h-full">
                <div className="at-logincontent flex justify-between">
                  ...
                  Please enter the new password below and press the reset
                  password button
                </span>
                            </div>
                        </div>
                        <form className="w-full" onSubmit={submit}>
                            <div className="at-forminputs relative">
                                <TextInput type="email" name="email" value={data.email}
                                           className="mt-1 block w-full" autoComplete="new-password"
                                           placeholder="Enter Email" isFocused={true} handleChange={onHandleChange}/>
                                <InputError message={errors.email} className="mt-2"/>
                            </div>
                            <div className="mt-4 at-forminputs relative">
                                <TextInput type="password" name="password" value={data.password}
                                           className="mt-1 block w-full" autoComplete="new-password"
                                           placeholder="Enter New Password" isFocused={true}
                            ...
                            <div className="flex items-center justify-center w-full mt-14">
                                ...
                                <PrimaryButton type="submit" className="w-full" processing={processing}>
                                    Reset Password
                                </PrimaryButton>
                                {/*</Link>*/}
                            </div>
