...
import { SelectPersonData } from '../../Data/SelectPersonData'
                            ...
                            >
                                <div className="at-deptdrodown min-w-[310px] bg-white border border-[#9c9c9c] rounded-lg min-h-[48px] px-[15px] flex items-center relative !bg-transparent">
                                    <div className="at-usernameemail">
                                        <span className="text-[#9C9C9C] font-product_sansregular text-sm">Select Person</span>
                                    </div>
                                    ...
                                    <form className="at-searchform w-full mb-0 p-[16px] pb-0">
                                        <fieldset className="">
                                            <div className="form-group relative">
                                                <input className="h-[40px] w-full rounded-lg border pr-[40px] border-bordercolor text-black placeholder:text-gray1 focus:border-black focus:ring-0" type="search" name="search" placeholder="Search Person" />
